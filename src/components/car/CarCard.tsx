      ...
      <div className="relative overflow-hidden rounded-xl bg-black">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/50 to-transparent">
          <div className="absolute bottom-0 w-full p-5 space-y-3">
            <h3 className="text-heading-3 text-white">{car.name}</h3>
            <div className="flex items-center gap-2 text-sm text-white/70">
              ...
              <span>{car.fuel}</span>
              <span>•</span>
              <span>{car.mileage}kms/day</span>
            </div>
            <div className="flex items-center justify-between pt-2">
              <div className="flex items-baseline gap-1">
                <span className="text-primary text-heading-3">AED {car.dailyPrice?.toLocaleString()}</span>
